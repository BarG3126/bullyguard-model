...
class MetricComparerConfig:
    _target_: str = "bullyguard.evaluation.model_selector.MetricComparer"
...
class ModelSelectorConfig:
    _target_: str = "bullyguard.evaluation.model_selector.ModelSelector"
...
@dataclass
class BullyingDetectionModelSelectorConfig(ModelSelectorConfig):
