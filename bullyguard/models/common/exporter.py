...
from bullyguard.models.common.io_utils import cache_gcs_resource_locally, copy_file
from bullyguard.models.common.utils import get_global_rank, get_local_rank, global_rank_zero_first, local_rank_zero_first
from bullyguard.utils.utils import get_logger

MODELS_MODULE_PATH = "bullyguard/models"
...
class TarModelLoader:
    ...
    def load_model(self, model_dir: str, model_config: Any) -> Any:
        ...
        state_dict = torch.load(f"{model_dir}/{STATE_DICT_PATH}", weights_only=False)
